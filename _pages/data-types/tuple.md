...
## Indexing
An index is the position of an element in a sequence (like a tuple). The first element is at index 0. Negative indexing begins at the last element with index -1. 
...
## Immutability
Lists are immutable, which means you cannot change their attributes after instantiation. 
